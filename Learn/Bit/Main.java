...
public class Main {
     ...
     * bitwise AND: n & m
     * bitwise OR : n | m
     * bitwise XOR: n ^ m; bit is 1 if the corresponding bits are different: 1100 ^ 1010 = 0110
    ...
    static void checkEvenOdd(int n) {
         ...
         * gives 0; 1 & 1 gives 1).
         * An even integer's right most bit will always be 0 and odd integer's will be 1.
         * example:
         * 2 = 0000 0010
         * 3 = 0000 0011
         */
    ...
    // this function checks if a number is a power of two i.e 2^n using a bruteforce method.
    /* logic: if a number is power of 2, it will have only one set-bit/"1" in its binary form.
        2^0: 1 in binary = 0000 0001
        2^1: 2 in binary = 0000 0010
        2^2: 4 in binary = 0000 0100

        So, if we count the no. of set bits in a number we can find out if it can be a power of 2.
        */
    ...
    */
    ...
    // question: find unique element from a list where all other elements appear twice.
