...
public class Problem3 {
    ...
    /*
    Problem: [3, 4, 1, 0, 5] -> missing number = 2 since it's not in range [0, 5] where 5 is number of elements.
    ...
    */
    ...
    so we can perform XOR operation between the range elements and the elements of the array.
    */
